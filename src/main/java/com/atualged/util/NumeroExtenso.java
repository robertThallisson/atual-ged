...
public class NumeroExtenso {
	 ...
	 * @param dec valor para colocar por extenso
	 */
	public NumeroExtenso(Float dec) {
		this();
		setNumber(dec);
	}
	 ...
	 * @param dec valor para colocar por extenso
	 */
	public NumeroExtenso(String dec) {
		this();
		setNumber(Float.valueOf(dec));
	}
	...
	public void setNumber(Long dec) {
		setNumber(new BigDecimal(dec));
	}
...
//		         }
	 ...
	 * @return Description of the Returned Value
	 */
	public boolean ehUltimoGrupo(int ps) {
